...
public class IESEngine
{
     ...
     * @param mac    the message authentication code generator for the message
     * @param cipher the cipher to used for encrypting the message
     * @param nonceGenerator A generator that produces IVs used by the block cipher, 
     * currently the only supported block ciphers are SIC/CTR, CBC, OFB, and CFB. 
     * The nonceGenerator provided must be initialized.
     */
    public IESEngine(
        BasicAgreement agree,
        DerivationFunction kdf,
